...
Time-limited, tamper-evident access tokens embedded directly in URLs. Generated by `Nene\Xion\SignedUrl`.
...
```php
$secret = \Nene\Xion\SignedUrl::generateSecret();
...
- `class/xion/SignedUrl.php` — implementation.
- `tests/Unit/Xion/SignedUrlTest.php` — unit tests (15 tests).
